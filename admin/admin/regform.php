<?php
 $con=new mysqli("localhost","root","","finaltest5");
    ...
    include('../admin/admin/process.php');
    if (isset($_GET['Book'])) {
        $date=$_GET['Book'];
...
<html lang="en">
<?php
 include("../admin/admin/regtest.php");
    ...
    <div class="modal-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group" id="myButton">
                    ...
                    <!--For Graduation-->
                <form action="admin/admin/process.php" method="POST" id="formElement" style="display: none;">
                <div class="form-group">
                  <?php
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    <label></label>
                    <textarea type="text" name="message" placeholder="Comment..." rows="3" cols="70"></textarea>
                </div>
                 <div class="form-group">
      ...
      <!--   <script type="text/javascript">
        ...
        document.getElementById('formElement').style.display = 'block';
            ...
            <!--For Glamour-->
                     <form action="admin/admin/process.php" method="POST" id="formGlamour" style="display: none;">
                <div class="form-group">
                   <?php
       ...
       <!--  <script type="text/javascript">
        ...
        document.getElementById('formGlamour').style.display = 'block';
                ...
                <!--For Wedding-->
                     <form action="admin/admin/process.php" method="POST" id="formWed" style="display: none;">
                <div class="form-group">
                   <?php
       ...
       <!--  <script type="text/javascript">
        ...
        document.getElementById('formWed').style.display = 'block';
                ...
                <!--For Birthday-->
                <form action="admin/admin/process.php" method="POST" id="formBirth" style="display: none;">
                <div class="form-group">
       ...
       <!--  <script type="text/javascript">
        ...
        <!--For Special events-->
                <form action="admin/admin/process.php" method="POST" id="formSpec" style="display: none;">
                <div class="form-group">
                   <?php
