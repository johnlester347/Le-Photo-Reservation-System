 ...
 <style type="text/css">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="registerd.php">Reservation Approval</a>
      </li>
      <li class="nav-item">
...
<form method="POST">
   <div class="col-md-12">
    ...
    <?php
      ...
      $id = $_GET['id'];
      $show="SELECT * FROM payment where id = ?";
      ...
      <div class="row">
          ...
          <div class="col-md-4">
             <div class="form-group">
                ...
                <div class="form-group">
                    <label>Name</label>
                    <input type="text" required readonly name="name" id="name" value="<?=$row['name'];?>" class="form-control timeslot">
                 </div>
                  <div class="form-group">
                    <label>Amount</label>
                    <input type="text" required readonly value="<?=$row['price'];?>" id="price" name="price" class="form-control ">
                 </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                    <label>Paid</label>
                    <input type="text" required name="amount" value="<?=$row['amount'];?>" id="amount" class="form-control">
                </div>
                <div class="form-group">
                    <label>Balance</label>
                    <input type="text" readonly required name="namount" value="<?=$row['namount'];?>" id="namount" class="form-control">
                </div>
  ...
  function Onsubmit(){
    ...
    var namount = $("#namount").val();
     $.ajax({
        url:'payment.php',
        method:'POST',
        data:{id:recordid,name:name,price:price,amount:amount,namount:namount},
        success:function(response){
          // alert(response);
